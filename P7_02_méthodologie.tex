...
\begin{figure}[h]
    \begin{center}
        \includegraphics[width=\textwidth]{./Figures/CurvesROCGridBest_base.pdf}
    \end{center}
...
\begin{figure}[h]
    \begin{center}
        \includegraphics[width=.7\textwidth]{./Figures/BestFeatGridF2_base.pdf}
    \end{center}
...
\begin{figure}[h]
    \begin{center}
        \includegraphics[width=.55\textwidth]{./Figures/shapSummary.pdf}
    \end{center}
...
\begin{figure}[h]
    \begin{center}
        \includegraphics[width=\textwidth]{./Figures/shapForce}
        \includegraphics[width=.7\textwidth]{./Figures/shapWaterfall.pdf}
    \end{center}
